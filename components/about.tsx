...
export default function About() {
  ...
  return (
    <motion.section ref={ref} className="mb-28 max-w-[45rem] text-center leading-8 sm:mb-0 scroll-mt-28" initial={{ opacity: 0, y: 100 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.175 }} id="about">
        ...
        <p className="mb-3">
          <Italic>When I'm not sitting in front of a screen</Italic>, I enjoy going to the gym, watching football, reading, and exploring the world &#40;<a className="underline text-blue-900 hover:text-red-400 visited:text-purple-600" target="_blank" href="https://www.youtube.com/watch?v=bKNHtNM4quI">Click here to learn about my exchange semester in Finland!</a>&#41; 🏋️‍♂️⚽️📕✈️. I have also recently gotten into blogging. Check out my Substack account <a href="https://arjunkundu.substack.com/" target="_blank" className="underline text-blue-900 hover:text-red-400 visited:text-purple-600">here</a> ✍️. 
        </p>
        <p>
